    ...
    <SidebarGroup class="px-2 py-0">
        ...
        <SidebarMenu >
            ...
            >
                ...
                <SidebarGroupLabel
                    as-child
                    class="group/label text-sm text-sidebar-foreground hover:bg-accent hover:text-dark-gray active:bg-accent active:text-dark-gray focus:bg-accent focus:text-dark-gray"
                ...
                <CollapsibleContent class="py-2 group-data-[collapsible=icon]:hidden">
                    <SidebarGroupContent>
                    <SidebarMenu>
                        <SidebarMenuItem v-for="childItem in item.items" :key="childItem.title" class="pl-6 hover:bg-accent hover:text-dark-gray active:bg-accent active:text-dark-gray focus:bg-accent focus:text-dark-gray">
                        <SidebarMenuButton as-child :is-active="childItem.href === page.url" :tooltip="childItem.title">
                            <Link :is-active="childItem.href === page.url" :href="childItem.href ?? '#'" isclass="hover:bg-accent hover:text-dark-gray active:bg-accent active:text-dark-gray focus:bg-accent focus:text-dark-gray">
